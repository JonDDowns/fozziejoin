...
testthat::test_that('Left join is correct for Hamming', {
	...
	expected <- data.frame(list(
		Name.x = c("Emma", "Smelia", "Laim", "No, ahhh", "Olive", "Jams", "A-A-ron", "Luças", "Oliv HEE-YAH", NA, "Ada"),
		Name.y = c("Emma", "Amelia", NA, NA, NA, NA, NA, NA, NA, NA, NA),
		int_col.y = c(NA, 8, NA, NA, NA, NA, NA, NA, NA, NA, NA), 
		real_col.y = c(7, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA), 
		logical_col.y = c(TRUE, FALSE, NA, NA, NA, NA, NA, NA, NA, NA, NA)
	))
