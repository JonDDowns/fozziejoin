...
#' @export
fozzie_interval_join_rs <- function(df1, df2, by, how, max_distance, distance_col, nthread) .Call(wrap__fozzie_interval_join_rs, df1, df2, by, how, max_distance, distance_col, nthread)
